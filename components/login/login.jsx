  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        // Ensure the redirect path is relative and doesn't redirect to external sites
  ...
  return (
    <div className="w-full max-w-sm px-4">
      ...
      >
        ...
        <div>
          <label htmlFor={fields.password.id} className="block text-sm mb-1">
            Password
          </label>
          <div className="relative">
            <input
              ...
              className={`w-full border rounded-md p-2 pr-10 ${
                fields.password.errors ? "border-red-500" : "border-gray-300"
              }`}
