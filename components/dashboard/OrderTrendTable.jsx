...
function OrderTrendTable({ className }) {
  ...
  return (
    <>
      <div className="flex flex-col xl:flex-row justify-between items-center lg:items-start mb-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-4 gap-3">
          <div className="flex flex-col lg:flex-row items-center w-full md:w-auto gap-2">
            <div className="flex items-center w-full xl:w-96 h-[40px] rounded-md overflow-hidden relative">
              ...
              <div className="relative z-10 flex w-full">
                <div className="flex-1 p-4 text-[#F0F1F3] text-sm xl:text-xl font-medium">
                  Total Order Count
                </div>
                <div className="p-4 text-[#F0F1F3] text-sm xl:text-xl font-bold">
                  {count}
                </div>
              </div>
            </div>
