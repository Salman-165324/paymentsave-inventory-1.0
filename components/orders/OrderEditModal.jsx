                ...
                <div className="border border-[#D9D9D9] rounded-md p-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-6">
                    ...
                    <AppSelect
                      ...
                      onChange={(value) => handleChange("terminalModel", value)}
                      required
                    />
                    <AppSelect
                      label="Terminal Condition"
                      value={formData.terminalCondition || ""}
                      onChange={(value) => handleChange("terminalCondition", value)}
                      required
                    />
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-4">
                        <div className="w-2/3">
                          <AppSelect
                            value={formData.accessoriesModel || ""}
                            onChange={(value) => handleChange("accessoriesModel", value)}
                          />
                        </div>
                        <div className="w-1/3">
                          <InputField
                            ...
                            value={formData.accessoriesQuantity || ""}
                            onChange={(e) => handleChange("accessoriesQuantity", e.target.value)}
                          />
                        </div>
                      </div>
                    </div>
                          ...
                          <tr key={key} className="border-b">
                            ...
                            <td className="py-2">
                              <input
                                ...
                                onChange={() => handleSoftwareChange(key, true)}
                              />
                            </td>
                            <td className="py-2">
                              <input
                                ...
                                onChange={() => handleSoftwareChange(key, false)}
                              />
                            </td>
                          </tr>
                        ))}
                  ...
                  <div className="mt-8">
                    ...
                    <div className="space-y-4">
                      <AppSelect
                        label="Auto Batch"
                        value={formData.autoBatch || ""}
                        onChange={(value) => handleChange("autoBatch", value)}
                        required
                      />
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <InputField
                          label="Till Roll Text 1"
                          value={formData.tillRollText1 || ""}
                          onChange={(e) => handleChange("tillRollText1", e.target.value)}
                          required
                        />
                        <InputField
                          label="Till Roll Text 2"
                          value={formData.tillRollText2 || ""}
                          onChange={(e) => handleChange("tillRollText2", e.target.value)}
                          required
                        />
                        <InputField
                          label="Till Roll Text 3"
                          value={formData.tillRollText3 || ""}
                          onChange={(e) => handleChange("tillRollText3", e.target.value)}
                        />
                      </div>
                    </div>
                  </div>
