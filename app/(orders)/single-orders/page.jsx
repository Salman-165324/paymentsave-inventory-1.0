...
import SingleOrdersTable from "@/components/orders/SingleOrdersTable";
export default function SingleOrdersPage() {
  return (
    <AdminLayout>
      <div className="bg-[#F9F9F9] p-6 rounded-xl shadow-[0px_4px_20px_0px_#00000040] mx-auto">
        {/* Table */}
        <SingleOrdersTable tableTitle="All Orders(Single Product Wise)" />
